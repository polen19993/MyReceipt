...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        app = MainApplication.getInstance(getApplicationContext());
    ...
    protected void updateTaskDescription(String title) {
        if (isApiLevel(Build.VERSION_CODES.LOLLIPOP)) {
            ...
            Bitmap icon = BitmapFactory.decodeResource(res, R.drawable.app_icon);
     ...
     */
    private void onSetStyle(MainTheme imgurTheme) {
        theme = imgurTheme;
