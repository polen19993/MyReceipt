...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public void addView(View child, int index, ViewGroup.LayoutParams params) {
		if (DEBUG) {
			Utils.printDebug(null, "addView: " + child.getClass().getSimpleName());
		}
	...
	public final void setMode(Mode mode) {
		if (mode != mMode) {
			if (DEBUG) {
				Utils.printDebug(null, "Setting mode to: " + mode);
			}
			mMode = mode;
			updateUIForMode();
		}
	...
	final void setState(State state, final boolean... params) {
		mState = state;
		if (DEBUG) {
			Utils.printDebug(null, "State: " + mState.name());
		}
	...
	protected final void onSizeChanged(int w, int h, int oldw, int oldh) {
		if (DEBUG) {
			Utils.printDebug(null, String.format("onSizeChanged. W: %d, H: %d", w, h));
		}
	...
	protected final void refreshLoadingViewsSize() {
		...
		if (DEBUG) {
			Utils.printDebug(null, String.format("Setting Padding. L: %d, T: %d, R: %d, B: %d", pLeft, pTop, pRight, pBottom));
		}
	...
	protected final void setHeaderScroll(int value) {
		if (DEBUG) {
			Utils.printDebug(null, "setHeaderScroll: " + value);
		}
