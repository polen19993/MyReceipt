package com.polen.receipt.api.classes;
...
public enum MainTheme {
    ...
    MainTheme(@StyleRes int theme, @StyleRes int darkTheme, @ColorRes int primaryColor, @ColorRes int darkColor, @ColorRes int accentColor) {
     ...
     * @return
     */
    public static MainTheme copy(MainTheme theme) {
        MainTheme copy;
    ...
    /**
     * Returns the {@link MainTheme} based on the saved primary color
     *
     ...
     */
    public static MainTheme fromPreferences(Resources res, int primaryColor) {
        MainTheme theme = null;

        for (MainTheme t : MainTheme.values()) {
